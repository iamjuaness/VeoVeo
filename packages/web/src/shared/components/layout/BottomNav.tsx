...
export function BottomNav() {
  ...
  return (
    <>
      <nav className="fixed bottom-0 left-0 right-0 z-50 bg-background/90 backdrop-blur-xl border-t border-border/50 flex justify-around items-center h-auto pt-3 pb-safe lg:hidden">
